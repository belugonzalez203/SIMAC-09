...
import ExecutedOrderDetails from "./views/OrderView/ExecutedOrderDetails.tsx";
import PrintOrder from "./components/PrintComponent.tsx";
import HourmeterAlerts from "./views/HourmeterView/HourmeterAlerts.tsx"
import TypeMaintenanceView from "./views/TypeMaintenanceView/TypeMaintenanceView.tsx";
    ...
    return (
        <MainLayout>
            <Routes>
                ...
                <Route path="*" element={<OrderReceivedList />} />
                <Route path="/order/received/:id" element={<ViewOrderReceived />} />
                <Route path="/order/receivedList" element={<OrderReceivedList />} />
                <Route path="/order/execute/:id" element={<ExecuteOrderView />} />
                <Route path="/order/executedList" element={<ListExecutedOrder />} />
                <Route path="/order/executed/:id" element={<ExecutedOrderDetails />} />
                <Route path="/horometros" element={<HourmetersPivotView />} />
                <Route path="/order/print/:id" element={<PrintOrder />} />
                <Route path="/hourmeters/alerts" element={<HourmeterAlerts />} />
                <Route path="/type/maintenance" element={<TypeMaintenanceView />} />
